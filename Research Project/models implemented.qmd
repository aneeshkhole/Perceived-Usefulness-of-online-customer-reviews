...
#     print(i)
#print(len(x))
test_frame['lm_pred_useful'] = LogMod.predict_proba(X_test_pca)[:,1]
...
dat = test_frame[test_frame['is_helpful']==0].sort_values(by='lm_pred_useful',ascending=False).head(10).copy().reset_index()
...
test_frame['knn_pred_useful'] = y_pred_3
dat = test_frame[test_frame['is_helpful']==0].sort_values(by='knn_pred_useful',ascending=False).head(10).copy().reset_index()
