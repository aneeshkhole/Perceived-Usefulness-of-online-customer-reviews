...
pd.DataFrame({
    ...
    'Reason for Inclusion':['research survey','research survey','intuition','intuition','research survey','intuition','research survey']
})
```
...
# mlr.fit(X_train_pca,y_train_mlr)
# y_hat_pca = mlr.predict(X_test_pca)
# beta_pca = mlr.coef_
# beta0_pca = mlr.intercept_
# R2_pca = r2_score(y_hat_pca,y_test_mlr)
# MSPE_pca = np.mean((y_hat_pca - y_test_mlr)**2)


# plt.scatter(y_hat_pca,y_test_mlr)
# plt.show()
```
